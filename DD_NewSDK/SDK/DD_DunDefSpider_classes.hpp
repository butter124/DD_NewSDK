...
// 0x004C (0x0D88 - 0x0D3C)
class ADunDefSpider : public ADunDefEnemy
{
public:
	struct FName                                       LungeAnimation;                                           // 0x0D3C(0x0008) (Edit)
	struct FName                                       WebShootAnimation;                                        // 0x0D44(0x0008) (Edit)
	struct FName                                       WebChargeAnimation;                                       // 0x0D4C(0x0008) (Edit)
	struct FName                                       WebShootSocket;                                           // 0x0D54(0x0008) (Edit)
	struct FName                                       MeleeSwingSocketName;                                     // 0x0D5C(0x0008) (Edit)
	struct FName                                       SpawnParticleMeshAttachmentSocket;                        // 0x0D64(0x0008) (Edit)
	float                                              MaxWebParticleScale;                                      // 0x0D6C(0x0004) (Edit)
	class UParticleSystemComponent*                    WebChargeParticleSystem;                                  // 0x0D70(0x0004) (Edit, ExportObject, Component, EditInline)
	class USoundCue*                                   WebChargeSound;                                           // 0x0D74(0x0004) (Edit)
	class UParticleSystemComponent*                    SpawnParticleEffect;                                      // 0x0D78(0x0004) (Edit, ExportObject, Component, EditInline)
	unsigned long                                      bAttachSpawnParticleToMesh : 1;                           // 0x0D7C(0x0004) (Edit)
	unsigned long                                      bUseSpawnEffect : 1;                                      // 0x0D7C(0x0004) (Edit)
	unsigned long                                      bPlayingWebCharge : 1;                                    // 0x0D7C(0x0004) (Net)
	unsigned long                                      bPlaySpawnEffect : 1;                                     // 0x0D7C(0x0004) (Net)
	float                                              WebStartTime;                                             // 0x0D80(0x0004)
	float                                              WebChargeTime;                                            // 0x0D84(0x0004) (Net)
...
{
public:
	float                                              StunDelay;                                                // 0x0D98(0x0004) (Edit)
	float                                              CoreDamageMultiplier;                                     // 0x0D9C(0x0004) (Edit)
	float                                              MinimumAngleDotForSuperHit;                               // 0x0DA0(0x0004) (Edit)
	TArray<float>                                      NonStunnedDmgScalar;                                      // 0x0DA4(0x000C) (Edit, NeedCtorLink)
	float                                              CurrentNonStunnedDmgScalar;                               // 0x0DB0(0x0004)
	float                                              BabySpawnPlayRate;                                        // 0x0DB4(0x0004) (Edit)
	struct FName                                       BabySpawnLocSocket;                                       // 0x0DB8(0x0008) (Edit)
	struct FName                                       BabySpawnAnimName;                                        // 0x0DC0(0x0008) (Edit)
	struct FName                                       StunnedAnimLoop;                                          // 0x0DC8(0x0008) (Edit)
	struct FName                                       CrystalSocketName;                                        // 0x0DD0(0x0008) (Edit)
	struct FName                                       MeleeSwingSocketName;                                     // 0x0DD8(0x0008) (Edit)
	struct FName                                       WebShootSocket;                                           // 0x0DE0(0x0008) (Edit)
	struct FName                                       WebShootAnimation;                                        // 0x0DE8(0x0008) (Edit)
	struct FName                                       StunnedHurtAnim;                                          // 0x0DF0(0x0008) (Edit)
	class ADunDefEmitterSpawnable*                     StunnedHurtEffectTemplate;                                // 0x0DF8(0x0004) (Edit)
	class UParticleSystemComponent*                    StunnedCoreVFX;                                           // 0x0DFC(0x0004) (Edit, ExportObject, Component, EditInline)
	class UParticleSystemComponent*                    EnragedVFX;                                               // 0x0E00(0x0004) (Edit, ExportObject, Component, EditInline)
	struct FName                                       EnrageSocketName;                                         // 0x0E04(0x0008) (Edit)
	struct FName                                       UpperBodyLookAtName;                                      // 0x0E0C(0x0008) (Edit)
	float                                              CrystalScaleDownTime;                                     // 0x0E14(0x0004) (Edit)
	float                                              MinCrystalBrightnessScale;                                // 0x0E18(0x0004) (Edit)
	float                                              EnrageHealthPct;                                          // 0x0E1C(0x0004) (Edit)
	float                                              EnrageDmgMult;                                            // 0x0E20(0x0004) (Edit)
	float                                              EnrageBabySpawnMult;                                      // 0x0E24(0x0004) (Edit)
	float                                              EnrageIntervalMult;                                       // 0x0E28(0x0004) (Edit)
	float                                              EnrageGroundSpeedMult;                                    // 0x0E2C(0x0004) (Edit)
	unsigned long                                      bRageMode : 1;                                            // 0x0E30(0x0004)
	unsigned long                                      bIsStunned : 1;                                           // 0x0E30(0x0004)
	unsigned long                                      bLookAtTarget : 1;                                        // 0x0E30(0x0004)
	float                                              TimeOfDeath;                                              // 0x0E34(0x0004)
	class UMaterialInstanceConstant*                   QueenMIC;                                                 // 0x0E38(0x0004)
	class USkelControlLookAt*                          UpperBodyLookAt;                                          // 0x0E3C(0x0004)
	class USkelControlLookAt*                          IKTest;                                                   // 0x0E40(0x0004)
	class AActor*                                      TheLastDamageCauser;                                      // 0x0E44(0x0004)
	float                                              WebChargeTime;                                            // 0x0E48(0x0004)
	float                                              WebStartTime;                                             // 0x0E4C(0x0004)
	float                                              currentTakenStunnedDamage;                                // 0x0E50(0x0004)
	float                                              AllowedDmgStunnedPct;                                     // 0x0E54(0x0004) (Edit)
	struct FLinearColor                                EnrageCoreColor;                                          // 0x0E58(0x0010) (Edit)
