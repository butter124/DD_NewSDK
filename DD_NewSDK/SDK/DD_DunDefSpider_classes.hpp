...
{
public:
	TArray<struct FWaveKillCounts>                     KillCountsPerPlayer;                                      // 0x0374(0x000C) (Edit, NeedCtorLink)
	TArray<struct FEnemyGenderOverride>                EnemyGenderOverrides;                                     // 0x0380(0x000C) (Edit, NeedCtorLink)
	float                                              MinTimeBetweenGenderSpawns;                               // 0x038C(0x0004) (Edit)
	float                                              MaxTimeBetweenGenderSpawns;                               // 0x0390(0x0004) (Edit)
	float                                              MinTimeBetweenPairSpawns;                                 // 0x0394(0x0004) (Edit)
	float                                              MaxTimeBetweenPairSpawns;                                 // 0x0398(0x0004) (Edit)
	float                                              MiniMapGenderIconSize;                                    // 0x039C(0x0004) (Edit)
	float                                              MiniMapGenderIconOffset;                                  // 0x03A0(0x0004) (Edit)
	float                                              PairMatchDistance;                                        // 0x03A4(0x0004) (Edit)
	TArray<int>                                        MaxGenderPairsAllowed;                                    // 0x03A8(0x000C) (Edit, NeedCtorLink)
	class ADunDefEmitterSpawnable*                     PairMatchedEffect;                                        // 0x03B4(0x0004) (Edit)
	class USoundCue*                                   PairMatchedHUDSound;                                      // 0x03B8(0x0004) (Edit)
	class USoundCue*                                   GenderSpawnedHUDSound;                                    // 0x03BC(0x0004) (Edit)
	unsigned long                                      bNotifyOnGenderSpawn : 1;                                 // 0x03C0(0x0004) (Edit)
	class UTexture2D*                                  BoyIcon;                                                  // 0x03C4(0x0004) (Edit)
	class UTexture2D*                                  GirlIcon;                                                 // 0x03C8(0x0004) (Edit)
	TArray<class ADunDefEnemy*>                        BoyArchetypes;                                            // 0x03CC(0x000C) (Edit, NeedCtorLink)
	TArray<class ADunDefEnemy*>                        GirlArchetypes;                                           // 0x03D8(0x000C) (Edit, NeedCtorLink)
...
// 0x004C (0x0DA0 - 0x0D54)
class ADunDefSpider : public ADunDefEnemy
{
public:
	struct FName                                       LungeAnimation;                                           // 0x0D54(0x0008) (Edit)
	struct FName                                       WebShootAnimation;                                        // 0x0D5C(0x0008) (Edit)
	struct FName                                       WebChargeAnimation;                                       // 0x0D64(0x0008) (Edit)
	struct FName                                       WebShootSocket;                                           // 0x0D6C(0x0008) (Edit)
	struct FName                                       MeleeSwingSocketName;                                     // 0x0D74(0x0008) (Edit)
	struct FName                                       SpawnParticleMeshAttachmentSocket;                        // 0x0D7C(0x0008) (Edit)
	float                                              MaxWebParticleScale;                                      // 0x0D84(0x0004) (Edit)
	class UParticleSystemComponent*                    WebChargeParticleSystem;                                  // 0x0D88(0x0004) (Edit, ExportObject, Component, EditInline)
	class USoundCue*                                   WebChargeSound;                                           // 0x0D8C(0x0004) (Edit)
	class UParticleSystemComponent*                    SpawnParticleEffect;                                      // 0x0D90(0x0004) (Edit, ExportObject, Component, EditInline)
	unsigned long                                      bAttachSpawnParticleToMesh : 1;                           // 0x0D94(0x0004) (Edit)
	unsigned long                                      bUseSpawnEffect : 1;                                      // 0x0D94(0x0004) (Edit)
	unsigned long                                      bPlayingWebCharge : 1;                                    // 0x0D94(0x0004) (Net)
	unsigned long                                      bPlaySpawnEffect : 1;                                     // 0x0D94(0x0004) (Net)
	float                                              WebStartTime;                                             // 0x0D98(0x0004)
	float                                              WebChargeTime;                                            // 0x0D9C(0x0004) (Net)
...
{
public:
	struct FMinMaxValues                               MinMaxEnemyHealth;                                        // 0x0374(0x0008) (Edit)
	struct FMinMaxValues                               MinMaxEnemyDamage;                                        // 0x037C(0x0008) (Edit)
	struct FMinMaxValues                               MinMaxEnemyScale;                                         // 0x0384(0x0008) (Edit)
	float                                              MaxAllowedCoreHits[0x5];                                  // 0x038C(0x0004) (Edit)
	struct FString                                     RemainingTouchesString;                                   // 0x03A0(0x000C) (Edit, Localized, NeedCtorLink)
...
{
public:
	int                                                currentPortal;                                            // 0x0540(0x0004)
	float                                              GameEnemyHealthMultiplier;                                // 0x0544(0x0004)
	float                                              GameEnemyDamageMultiplier;                                // 0x0548(0x0004)
	float                                              GameEnemyScaleMultiplier;                                 // 0x054C(0x0004)
...
{
public:
	float                                              StunDelay;                                                // 0x0DB0(0x0004) (Edit)
	float                                              CoreDamageMultiplier;                                     // 0x0DB4(0x0004) (Edit)
	float                                              MinimumAngleDotForSuperHit;                               // 0x0DB8(0x0004) (Edit)
	TArray<float>                                      NonStunnedDmgScalar;                                      // 0x0DBC(0x000C) (Edit, NeedCtorLink)
	float                                              CurrentNonStunnedDmgScalar;                               // 0x0DC8(0x0004)
	float                                              BabySpawnPlayRate;                                        // 0x0DCC(0x0004) (Edit)
	struct FName                                       BabySpawnLocSocket;                                       // 0x0DD0(0x0008) (Edit)
	struct FName                                       BabySpawnAnimName;                                        // 0x0DD8(0x0008) (Edit)
	struct FName                                       StunnedAnimLoop;                                          // 0x0DE0(0x0008) (Edit)
	struct FName                                       CrystalSocketName;                                        // 0x0DE8(0x0008) (Edit)
	struct FName                                       MeleeSwingSocketName;                                     // 0x0DF0(0x0008) (Edit)
	struct FName                                       WebShootSocket;                                           // 0x0DF8(0x0008) (Edit)
	struct FName                                       WebShootAnimation;                                        // 0x0E00(0x0008) (Edit)
	struct FName                                       StunnedHurtAnim;                                          // 0x0E08(0x0008) (Edit)
	class ADunDefEmitterSpawnable*                     StunnedHurtEffectTemplate;                                // 0x0E10(0x0004) (Edit)
	class UParticleSystemComponent*                    StunnedCoreVFX;                                           // 0x0E14(0x0004) (Edit, ExportObject, Component, EditInline)
	class UParticleSystemComponent*                    EnragedVFX;                                               // 0x0E18(0x0004) (Edit, ExportObject, Component, EditInline)
	struct FName                                       EnrageSocketName;                                         // 0x0E1C(0x0008) (Edit)
	struct FName                                       UpperBodyLookAtName;                                      // 0x0E24(0x0008) (Edit)
	float                                              CrystalScaleDownTime;                                     // 0x0E2C(0x0004) (Edit)
	float                                              MinCrystalBrightnessScale;                                // 0x0E30(0x0004) (Edit)
	float                                              EnrageHealthPct;                                          // 0x0E34(0x0004) (Edit)
	float                                              EnrageDmgMult;                                            // 0x0E38(0x0004) (Edit)
	float                                              EnrageBabySpawnMult;                                      // 0x0E3C(0x0004) (Edit)
	float                                              EnrageIntervalMult;                                       // 0x0E40(0x0004) (Edit)
	float                                              EnrageGroundSpeedMult;                                    // 0x0E44(0x0004) (Edit)
	unsigned long                                      bRageMode : 1;                                            // 0x0E48(0x0004)
	unsigned long                                      bIsStunned : 1;                                           // 0x0E48(0x0004)
	unsigned long                                      bLookAtTarget : 1;                                        // 0x0E48(0x0004)
	float                                              TimeOfDeath;                                              // 0x0E4C(0x0004)
	class UMaterialInstanceConstant*                   QueenMIC;                                                 // 0x0E50(0x0004)
	class USkelControlLookAt*                          UpperBodyLookAt;                                          // 0x0E54(0x0004)
	class USkelControlLookAt*                          IKTest;                                                   // 0x0E58(0x0004)
	class AActor*                                      TheLastDamageCauser;                                      // 0x0E5C(0x0004)
	float                                              WebChargeTime;                                            // 0x0E60(0x0004)
	float                                              WebStartTime;                                             // 0x0E64(0x0004)
	float                                              currentTakenStunnedDamage;                                // 0x0E68(0x0004)
	float                                              AllowedDmgStunnedPct;                                     // 0x0E6C(0x0004) (Edit)
	struct FLinearColor                                EnrageCoreColor;                                          // 0x0E70(0x0010) (Edit)
...
// 0x0024 (0x0564 - 0x0540)
class AGameInfo_VDay : public AMain
{
public:
	TArray<class ADunDefEnemy*>                        Boys;                                                     // 0x0540(0x000C) (NeedCtorLink)
	TArray<class ADunDefEnemy*>                        Girls;                                                    // 0x054C(0x000C) (NeedCtorLink)
	unsigned long                                      bUsingGenderSpawnTimer : 1;                               // 0x0558(0x0004)
	float                                              GenderSpawnTimer;                                         // 0x055C(0x0004)
	class UUI_KillCount*                               myKillCountUI;                                            // 0x0560(0x0004)
