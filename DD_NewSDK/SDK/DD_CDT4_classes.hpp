...
// 0x008C (0x0C54 - 0x0BC8)
class UHeroEquipment_Familiar_CoreHealer : public UHeroEquipment_Familiar
{
public:
	float                                              ManaCostStatBase;                                         // 0x0BC8(0x0004) (Edit)
	float                                              ManaCostMultiplier;                                       // 0x0BCC(0x0004) (Edit)
	float                                              ManaCostExponent;                                         // 0x0BD0(0x0004) (Edit)
	float                                              ManaCostMin;                                              // 0x0BD4(0x0004) (Edit)
	float                                              ManaCostMax;                                              // 0x0BD8(0x0004) (Edit)
	float                                              HealAmountBase;                                           // 0x0BDC(0x0004) (Edit)
	float                                              HealAmountMultiplier;                                     // 0x0BE0(0x0004) (Edit)
	float                                              HealAmountExtraMultiplier;                                // 0x0BE4(0x0004) (Edit)
	float                                              HealAmountMaxPercent;                                     // 0x0BE8(0x0004) (Edit)
	float                                              MinimumCoreHealthPercent;                                 // 0x0BEC(0x0004) (Edit)
	float                                              HealInterval;                                             // 0x0BF0(0x0004) (Edit)
	float                                              HealRangeBase;                                            // 0x0BF4(0x0004) (Edit)
	float                                              HealRangeStatBase;                                        // 0x0BF8(0x0004) (Edit)
	float                                              HealRangeStatMultiplier;                                  // 0x0BFC(0x0004) (Edit)
	float                                              HealRangeStatExponent;                                    // 0x0C00(0x0004) (Edit)
	float                                              HealRangeMaxEffectiveStat;                                // 0x0C04(0x0004) (Edit)
	float                                              NightmareHealingMultiplier;                               // 0x0C08(0x0004) (Edit)
	float                                              RotationSpeed;                                            // 0x0C0C(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     CoreHealEffect;                                           // 0x0C10(0x0004) (Edit)
	unsigned long                                      bHealInCombatPhaseOnly : 1;                               // 0x0C14(0x0004) (Edit)
	unsigned long                                      bDebug : 1;                                               // 0x0C14(0x0004) (Edit)
	struct FString                                     StringHealAmount;                                         // 0x0C18(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     StringHealSpeed;                                          // 0x0C24(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     StringHealRange;                                          // 0x0C30(0x000C) (Edit, Localized, NeedCtorLink)
	float                                              LastHealTime;                                             // 0x0C3C(0x0004) (Transient)
	TScriptInterface<class UDunDefTargetableInterface> BestTargetRef;                                            // 0x0C40(0x0008) (Transient)
	struct FRotator                                    CurrentRotation;                                          // 0x0C48(0x000C) (Transient)
...
// 0x0008 (0x0D4C - 0x0D44)
class UHeroEquipment_Familiar_MiniQueen : public UHeroEquipment_Familiar_Melee
{
public:
	float                                              WebOverrideRange;                                         // 0x0D44(0x0004) (Edit)
	unsigned long                                      bNextAttackRanged : 1;                                    // 0x0D48(0x0004) (Transient)
