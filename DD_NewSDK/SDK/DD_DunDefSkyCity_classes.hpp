...
// 0x0098 (0x05AC - 0x0514)
class ADunDef_OldOneCrystals : public ADunDefDamageableTarget
{
public:
	struct FName                                       SocketBaseName;                                           // 0x0514(0x0008) (Edit)
	class UStaticMeshComponent*                        MyMesh;                                                   // 0x051C(0x0004) (Edit, ExportObject, Component, EditInline)
	class UStaticMeshComponent*                        CollisionMesh;                                            // 0x0520(0x0004) (Edit, ExportObject, Component, EditInline)
	class UParticleSystemComponent*                    ActiveParticle;                                           // 0x0524(0x0004) (Edit, ExportObject, Component, EditInline)
	class UDynamicLightEnvironmentComponent*           LightEnvironment;                                         // 0x0528(0x0004) (Edit, ExportObject, Component, EditInline)
	TEnumAsByte<EPhase>                                myPhase;                                                  // 0x052C(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x052D(0x0003) MISSED OFFSET
	unsigned long                                      bLimitDamageOnActivation : 1;                             // 0x0530(0x0004) (Edit)
	unsigned long                                      bFullHealOnDeath : 1;                                     // 0x0530(0x0004) (Edit)
	unsigned long                                      bPrimaryCrystal : 1;                                      // 0x0530(0x0004) (Edit)
	unsigned long                                      bDoDamageFlashing : 1;                                    // 0x0530(0x0004) (Edit)
	unsigned long                                      bDamageFlashOldOne : 1;                                   // 0x0530(0x0004) (Edit)
	unsigned long                                      bShutDown : 1;                                            // 0x0530(0x0004) (Net, Transient)
	unsigned long                                      bInPlay : 1;                                              // 0x0530(0x0004) (Net, Transient)
	float                                              MaxAllowedDmgPct;                                         // 0x0534(0x0004) (Edit)
	struct FName                                       MeshActiveColorParamName;                                 // 0x0538(0x0008) (Edit)
	struct FName                                       DissolveParamName;                                        // 0x0540(0x0008) (Edit)
	struct FLinearColor                                ActiveColor;                                              // 0x0548(0x0010) (Edit)
	struct FLinearColor                                InActiveColor;                                            // 0x0558(0x0010) (Edit)
	struct FName                                       HurtAnimName;                                             // 0x0568(0x0008) (Edit)
	float                                              NotifyAtHealthPct;                                        // 0x0570(0x0004) (Edit)
	float                                              ActivateTime;                                             // 0x0574(0x0004) (Edit)
	float                                              DissolveTime;                                             // 0x0578(0x0004) (Edit)
	float                                              LastFlashingDamageTime;                                   // 0x057C(0x0004) (Transient)
	float                                              DamageFlashingDuration;                                   // 0x0580(0x0004) (Edit)
	float                                              DamageFlashingFadeExponent;                               // 0x0584(0x0004) (Edit)
	float                                              DamageFlashingIntensity;                                  // 0x0588(0x0004) (Edit)
	struct FName                                       DamageFlashingScalarParamName;                            // 0x058C(0x0008) (Edit)
...
{
public:
	float                                              MaxTargetDeltaPitch;                                      // 0x0350(0x0004) (Edit)
	float                                              MaxTargetDeltaYaw;                                        // 0x0354(0x0004) (Edit)
	unsigned long                                      bCheckPlayerInvincibility : 1;                            // 0x0358(0x0004) (Edit)
...
// 0x00DC (0x0E30 - 0x0D54)
class ADunDefGoblinCopter : public ADunDefEnemy
{
public:
	TArray<struct FHoldAI>                             HoldableTemplates;                                        // 0x0D54(0x000C) (Edit, NeedCtorLink)
	struct FName                                       DropOffAnimName;                                          // 0x0D60(0x0008) (Edit)
	struct FName                                       ShootLeftAnimName;                                        // 0x0D68(0x0008) (Edit)
	struct FName                                       ShootRightAnimName;                                       // 0x0D70(0x0008) (Edit)
	struct FName                                       ShootDoubleAnimName;                                      // 0x0D78(0x0008) (Edit)
	TArray<struct FName>                               SpawnInAnimName;                                          // 0x0D80(0x000C) (Edit, NeedCtorLink)
	struct FName                                       ShootLeftSocketName;                                      // 0x0D8C(0x0008) (Edit)
	struct FName                                       ShootRightSocketName;                                     // 0x0D94(0x0008) (Edit)
	float                                              DeathVelocityForce;                                       // 0x0D9C(0x0004) (Edit)
	float                                              DeathSpinRotRate;                                         // 0x0DA0(0x0004) (Edit)
	float                                              MiniMapHoldOffset;                                        // 0x0DA4(0x0004) (Edit)
	float                                              MiniMapHoldIconSize;                                      // 0x0DA8(0x0004) (Edit)
	float                                              HeldMiniMapIconSize;                                      // 0x0DAC(0x0004) (Net)
	TArray<class ADunDefEmitterSpawnable*>             DestructionEffects;                                       // 0x0DB0(0x000C) (Edit, NeedCtorLink)
	class ADunDefEmitterSpawnable*                     FlareTemplate;                                            // 0x0DBC(0x0004) (Edit)
	struct FName                                       RightFlareSocketName;                                     // 0x0DC0(0x0008) (Edit)
	struct FName                                       LeftFlareSocketName;                                      // 0x0DC8(0x0008) (Edit)
	float                                              FlareVelocity;                                            // 0x0DD0(0x0004) (Edit)
	float                                              FlareFallSpeed;                                           // 0x0DD4(0x0004) (Edit)
	float                                              FlareLifeSpan;                                            // 0x0DD8(0x0004) (Edit)
	float                                              FlareLifeSpanOffset;                                      // 0x0DDC(0x0004) (Edit)
	struct FRotator                                    FlareRotOffset;                                           // 0x0DE0(0x000C) (Edit)
	TArray<struct FHeldPawnDifficultyOffset>           HeldPawnDifficultyOffsets;                                // 0x0DEC(0x000C) (Edit, NeedCtorLink)
	TArray<class UClass*>                              IgnoreDmgTypesWithFlare;                                  // 0x0DF8(0x000C) (Edit, NeedCtorLink)
	float                                              PctDmgtoDroppedPawnOnDrop;                                // 0x0E04(0x0004) (Edit)
	unsigned long                                      bUsePawnElementalEntry : 1;                               // 0x0E08(0x0004) (Edit)
	unsigned long                                      bPawnUsedLocInterp : 1;                                   // 0x0E08(0x0004) (Net)
	unsigned long                                      bPawnUsedClientRotInterp : 1;                             // 0x0E08(0x0004) (Net)
	unsigned long                                      bStartFalling : 1;                                        // 0x0E08(0x0004)
	unsigned long                                      bDamagePawnOnDrop : 1;                                    // 0x0E08(0x0004)
	class ADunDefEmitterSpawnable*                     myCurrentFlare;                                           // 0x0E0C(0x0004) (Transient)
	class ADunDefEnemy*                                currentHeldPawn;                                          // 0x0E10(0x0004) (Net)
	int                                                currentHeldIndex;                                         // 0x0E14(0x0004) (Net)
	struct FVector                                     currentHoldOffset;                                        // 0x0E18(0x000C)
	int                                                GCopterNumber;                                            // 0x0E24(0x0004)
	float                                              CopterPushForce;                                          // 0x0E28(0x0004)
	float                                              CopterProxDistance;                                       // 0x0E2C(0x0004)
