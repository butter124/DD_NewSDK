...
public:
  ...
  inline bool IsValidIndex(size_t i) const { return i < Num(); }

  inline T &GetByIndex(size_t i) { return Data[i]; }
...
public:
  ...
  inline const char *GetName() const { return Flags & 0x4000 ? NamePtr : Name; }
};
...
struct FName {
  ...
  inline FName(int32_t i) : Index(i), Number(0) {};

  FName(const char *nameToFind) : Index(0), Number(0) {
  ...
  static inline TArray<FNameEntry *> &GetGlobalNames() { return *GNames; };
...
public:
  inline UObject *GetObject() const { return ObjectPointer; }

  inline UObject *&GetObjectRef() { return ObjectPointer; }
...
public:
  ...
  inline operator bool() const { return GetInterface() != nullptr; }
};
