...
// 0x00FC (0x0BFC - 0x0B00)
class UHeroEquipment_Familiar_TowerDamageScaling : public UHeroEquipment_Familiar
{
public:
	float                                              ProjectileShootInterval;                                  // 0x0B00(0x0004) (Edit)
	class ADunDefProjectile*                           ProjectileTemplate;                                       // 0x0B04(0x0004) (Edit)
	class ADunDefProjectile*                           ProjectileTemplateAlt;                                    // 0x0B08(0x0004) (Edit)
	TArray<class ADunDefProjectile*>                   ProjectileTemplates;                                      // 0x0B0C(0x000C) (Edit, NeedCtorLink)
	struct FName                                       FamiliarSocketName;                                       // 0x0B18(0x0008) (Edit)
	struct FName                                       MuzzleSocketName;                                         // 0x0B20(0x0008) (Edit)
	struct FName                                       ShootEffectSocket;                                        // 0x0B28(0x0008) (Edit)
	float                                              TargetRange;                                              // 0x0B30(0x0004) (Edit)
	unsigned long                                      ScaleTowerDamage : 1;                                     // 0x0B34(0x0004) (Edit)
	unsigned long                                      bUseFixedShootSpeed : 1;                                  // 0x0B34(0x0004) (Edit)
	unsigned long                                      bShootProjectileWithoutTarget : 1;                        // 0x0B34(0x0004) (Edit)
	unsigned long                                      bForceProjectileMuzzleRotation : 1;                       // 0x0B34(0x0004) (Edit)
	unsigned long                                      bIgnoreHurtAnimationWhenShooting : 1;                     // 0x0B34(0x0004) (Edit)
	unsigned long                                      bSlowEnemyTarget : 1;                                     // 0x0B34(0x0004) (Edit)
	unsigned long                                      bWeakenEnemyTarget : 1;                                   // 0x0B34(0x0004) (Edit)
	unsigned long                                      bUseProjectileImpactedDelegate : 1;                       // 0x0B34(0x0004) (Edit)
	unsigned long                                      bMythicalScaleTowerDamage : 1;                            // 0x0B34(0x0004) (Edit)
	unsigned long                                      bChooseHealingTarget : 1;                                 // 0x0B34(0x0004) (Edit)
	unsigned long                                      bProjectilesCollideWithOwner : 1;                         // 0x0B34(0x0004) (Edit)
	unsigned long                                      bAddManaForDamage : 1;                                    // 0x0B34(0x0004) (Edit)
	unsigned long                                      bUseAltProjectile : 1;                                    // 0x0B34(0x0004) (Edit)
	unsigned long                                      bIgnoreElementInTargeting : 1;                            // 0x0B34(0x0004) (Edit)
	unsigned long                                      bDoShotsPerSecondBonusCap : 1;                            // 0x0B34(0x0004) (Edit)
	unsigned long                                      DoLineOfSightCheck : 1;                                   // 0x0B34(0x0004) (Edit)
	unsigned long                                      bDidAddManaForDamage : 1;                                 // 0x0B34(0x0004) (Transient)
	TArray<struct FVector>                             ProjectileSpawnOffsets;                                   // 0x0B38(0x000C) (Edit, NeedCtorLink)
	struct FVector                                     ProjectileSpawnOffset;                                    // 0x0B44(0x000C) (Edit)
	TArray<struct FRotator>                            ProjectileRotOffsets;                                     // 0x0B50(0x000C) (Edit, NeedCtorLink)
	TArray<float>                                      ProjectileDelays;                                         // 0x0B5C(0x000C) (Edit, NeedCtorLink)
	float                                              MinimumProjectileSpeed;                                   // 0x0B68(0x0004) (Edit)
	float                                              ProjectileSpeedBonusMultiplier;                           // 0x0B6C(0x0004) (Edit)
	float                                              MaxAttackAnimationSpeed;                                  // 0x0B70(0x0004) (Edit)
	float                                              ProjectileDamageMultiplier;                               // 0x0B74(0x0004) (Edit)
	float                                              ShotsPerSecondExponent;                                   // 0x0B78(0x0004) (Edit)
	float                                              ShotsPerSecondAnimExponent;                               // 0x0B7C(0x0004) (Edit)
	float                                              AbsoluteDamageMultiplier;                                 // 0x0B80(0x0004) (Edit)
	float                                              SlowEnemyTargetPercentage;                                // 0x0B84(0x0004) (Edit)
	float                                              WeakenEnemyTargetPercentage;                              // 0x0B88(0x0004) (Edit)
	float                                              EnemyClearSlowTime;                                       // 0x0B8C(0x0004) (Edit)
	float                                              MythicalScaleDamageStatExponent;                          // 0x0B90(0x0004) (Edit)
	float                                              EnemyClearWeakenTime;                                     // 0x0B94(0x0004) (Edit)
	float                                              NightmareDamageMultiplier;                                // 0x0B98(0x0004) (Edit)
	float                                              ExtraNightmareDamageMultiplier;                           // 0x0B9C(0x0004) (Edit)
	TEnumAsByte<ELevelUpValueType>                     MythicalScaleDamageStatType;                              // 0x0BA0(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0BA1(0x0003) MISSED OFFSET
	class USoundCue*                                   ShootSound;                                               // 0x0BA4(0x0004) (Edit)
	class UParticleSystem*                             ShootEffect;                                              // 0x0BA8(0x0004) (Edit)
	float                                              BaseHealAmount;                                           // 0x0BAC(0x0004) (Edit)
	float                                              HealAmountMultiplier;                                     // 0x0BB0(0x0004) (Edit)
	float                                              NightmareHealingMultiplier;                               // 0x0BB4(0x0004) (Edit)
	float                                              AltProjectileMinimumRange;                                // 0x0BB8(0x0004) (Edit)
	float                                              HealingPriorityHealthPercentage;                          // 0x0BBC(0x0004) (Edit)
	struct FName                                       AttackAnimationAlt;                                       // 0x0BC0(0x0008) (Edit)
	int                                                ShotsPerSecondBonusCap;                                   // 0x0BC8(0x0004) (Edit)
	float                                              BaseDamageToManaRatio;                                    // 0x0BCC(0x0004) (Edit)
	float                                              ManaMultiplier;                                           // 0x0BD0(0x0004) (Edit)
	float                                              MaxManaPerDamage;                                         // 0x0BD4(0x0004) (Edit)
	float                                              MinManaPerDamage;                                         // 0x0BD8(0x0004) (Edit)
	float                                              MaxManaMultiplierExponent;                                // 0x0BDC(0x0004) (Edit)
	float                                              DamageManaMultiplierExponent;                             // 0x0BE0(0x0004) (Edit)
	float                                              LastShootProjectileTime;                                  // 0x0BE4(0x0004) (Transient)
	TScriptInterface<class UDunDefTargetableInterface> BestTargetRef;                                            // 0x0BE8(0x0008)
	TArray<struct UHeroEquipment_Familiar_TowerDamageScaling_FDelayedShot> DelayedShots;                                             // 0x0BF0(0x000C) (Transient, NeedCtorLink)
...
// 0x0060 (0x0C5C - 0x0BFC)
class UHeroEquipment_Familiar_Melee_TowerScaling : public UHeroEquipment_Familiar_TowerDamageScaling
{
public:
	float                                              MeleeHitRadius;                                           // 0x0BFC(0x0004) (Edit)
	float                                              MeleeDamageMomentum;                                      // 0x0C00(0x0004) (Edit)
	class UClass*                                      MeleeDamageType;                                          // 0x0C04(0x0004) (Edit)
	float                                              MaxKnockbackMultiplier;                                   // 0x0C08(0x0004) (Edit)
	float                                              KnockbackBonusLinearScale;                                // 0x0C0C(0x0004) (Edit)
	float                                              KnockbackBonusExpScale;                                   // 0x0C10(0x0004) (Edit)
	unsigned long                                      bAlsoShootProjectile : 1;                                 // 0x0C14(0x0004) (Edit)
	unsigned long                                      ScaleMeleeDamageForHero : 1;                              // 0x0C14(0x0004) (Edit)
	unsigned long                                      bUseRandomizedDamage : 1;                                 // 0x0C14(0x0004) (Edit)
	unsigned long                                      bDoMeleeHealing : 1;                                      // 0x0C14(0x0004) (Edit)
	unsigned long                                      bIsAttacking : 1;                                         // 0x0C14(0x0004)
	float                                              MeleeRange;                                               // 0x0C18(0x0004) (Edit)
	float                                              ScaleDamageStatExponent;                                  // 0x0C1C(0x0004) (Edit)
	float                                              ExtraNightmareMeleeDamageMultiplier;                      // 0x0C20(0x0004) (Edit)
	struct FName                                       AlsoShootProjectileAnimation;                             // 0x0C24(0x0008) (Edit)
	TEnumAsByte<ELevelUpValueType>                     ScaleMeleeDamageForHeroStatType;                          // 0x0C2C(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0C2D(0x0003) MISSED OFFSET
	int                                                RandomizedDamageMultiplierMaximum;                        // 0x0C30(0x0004) (Edit)
	float                                              RandomizedDamageMultiplierDivisor;                        // 0x0C34(0x0004) (Edit)
	float                                              BaseDamageToHealRatio;                                    // 0x0C38(0x0004) (Edit)
	float                                              EquipmentDamageMultiplierBase;                            // 0x0C3C(0x0004) (Edit)
	float                                              MaxHealPerDamage;                                         // 0x0C40(0x0004) (Edit)
	float                                              MinHealPerDamage;                                         // 0x0C44(0x0004) (Edit)
	float                                              MaxHealMultiplierExponent;                                // 0x0C48(0x0004) (Edit)
	float                                              DamageHealMultiplierExponent;                             // 0x0C4C(0x0004) (Edit)
	TArray<class AActor*>                              SwingHurtList;                                            // 0x0C50(0x000C) (NeedCtorLink)
