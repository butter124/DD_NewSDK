...
public:
	...
	unsigned long                                      ScaleTowerDamage : 1;                                     // 0x0B78(0x0004) (Edit)
	...
	unsigned long                                      bMythicalScaleTowerDamage : 1;                            // 0x0B78(0x0004) (Edit)
	...
	float                                              BaseDamageToManaRatio;                                    // 0x0C10(0x0004) (Edit)
	float                                              ManaMultiplier;                                           // 0x0C14(0x0004) (Edit)
	float                                              MaxManaPerDamage;                                         // 0x0C18(0x0004) (Edit)
	float                                              MinManaPerDamage;                                         // 0x0C1C(0x0004) (Edit)
	float                                              MaxManaMultiplierExponent;                                // 0x0C20(0x0004) (Edit)
	float                                              DamageManaMultiplierExponent;                             // 0x0C24(0x0004) (Edit)
	float                                              LastShootProjectileTime;                                  // 0x0C28(0x0004) (Transient)
	TScriptInterface<class UDunDefTargetableInterface> BestTargetRef;                                            // 0x0C2C(0x0008)
	TArray<struct UHeroEquipment_Familiar_TowerDamageScaling_FDelayedShot> DelayedShots;                                             // 0x0C34(0x000C) (Transient, NeedCtorLink)
...
{
public:
	float                                              MeleeHitRadius;                                           // 0x0C40(0x0004) (Edit)
	float                                              MeleeDamageMomentum;                                      // 0x0C44(0x0004) (Edit)
	class UClass*                                      MeleeDamageType;                                          // 0x0C48(0x0004) (Edit)
	float                                              MaxKnockbackMultiplier;                                   // 0x0C4C(0x0004) (Edit)
	float                                              KnockbackBonusLinearScale;                                // 0x0C50(0x0004) (Edit)
	float                                              KnockbackBonusExpScale;                                   // 0x0C54(0x0004) (Edit)
	unsigned long                                      bAlsoShootProjectile : 1;                                 // 0x0C58(0x0004) (Edit)
	unsigned long                                      ScaleMeleeDamageForHero : 1;                              // 0x0C58(0x0004) (Edit)
	unsigned long                                      bUseRandomizedDamage : 1;                                 // 0x0C58(0x0004) (Edit)
	unsigned long                                      bDoMeleeHealing : 1;                                      // 0x0C58(0x0004) (Edit)
	unsigned long                                      bIsAttacking : 1;                                         // 0x0C58(0x0004)
	float                                              MeleeRange;                                               // 0x0C5C(0x0004) (Edit)
	float                                              ScaleDamageStatExponent;                                  // 0x0C60(0x0004) (Edit)
	float                                              ExtraNightmareMeleeDamageMultiplier;                      // 0x0C64(0x0004) (Edit)
	struct FName                                       AlsoShootProjectileAnimation;                             // 0x0C68(0x0008) (Edit)
	TEnumAsByte<ELevelUpValueType>                     ScaleMeleeDamageForHeroStatType;                          // 0x0C70(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0C71(0x0003) MISSED OFFSET
	int                                                RandomizedDamageMultiplierMaximum;                        // 0x0C74(0x0004) (Edit)
	float                                              RandomizedDamageMultiplierDivisor;                        // 0x0C78(0x0004) (Edit)
	float                                              BaseDamageToHealRatio;                                    // 0x0C7C(0x0004) (Edit)
	float                                              EquipmentDamageMultiplierBase;                            // 0x0C80(0x0004) (Edit)
	float                                              MaxHealPerDamage;                                         // 0x0C84(0x0004) (Edit)
	float                                              MinHealPerDamage;                                         // 0x0C88(0x0004) (Edit)
	float                                              MaxHealMultiplierExponent;                                // 0x0C8C(0x0004) (Edit)
	float                                              DamageHealMultiplierExponent;                             // 0x0C90(0x0004) (Edit)
	TArray<class AActor*>                              SwingHurtList;                                            // 0x0C94(0x000C) (NeedCtorLink)
