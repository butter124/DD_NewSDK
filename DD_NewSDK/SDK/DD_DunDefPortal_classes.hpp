...
// 0x00AA (0x05AC - 0x0502)
class ADunDefWeapon_PortalGun : public ADunDefWeapon
{
public:
	unsigned char                                      UnknownData00[0x2];                                       // 0x0502(0x0002) MISSED OFFSET
	struct FName                                       CustomAnimNodeName;                                       // 0x0504(0x0008) (Edit)
	struct FName                                       PrimaryShootAnimName;                                     // 0x050C(0x0008) (Edit)
	struct FName                                       AltShootAnimName;                                         // 0x0514(0x0008) (Edit)
	struct FName                                       PrimaryCancelAnimName;                                    // 0x051C(0x0008) (Edit)
	struct FName                                       AltCancelAnimName;                                        // 0x0524(0x0008) (Edit)
	class ADunDefPortalNode*                           PortalNodeTemplates[0x2];                                 // 0x052C(0x0004) (Edit)
	class AActor*                                      AltTemplate;                                              // 0x0534(0x0004) (Edit)
	float                                              PortalFireInterval;                                       // 0x0538(0x0004) (Edit)
	float                                              PortalKillRadius;                                         // 0x053C(0x0004) (Edit)
	float                                              AmmoRegenInterval;                                        // 0x0540(0x0004) (Edit)
	float                                              AmmoRegenAmount;                                          // 0x0544(0x0004) (Edit)
	float                                              AmmoConsumeInterval;                                      // 0x0548(0x0004) (Edit)
	float                                              AmmoConsumeAmount;                                        // 0x054C(0x0004) (Edit)
	float                                              FullDrainRegenTimePenalty;                                // 0x0550(0x0004) (Edit)
	struct FLinearColor                                PrimaryFireColor;                                         // 0x0554(0x0010) (Edit)
	struct FLinearColor                                AltFireColor;                                             // 0x0564(0x0010) (Edit)
	struct FColor                                      PrimaryFireLightColor;                                    // 0x0574(0x0004) (Edit)
	struct FColor                                      AltFireLightColor;                                        // 0x0578(0x0004) (Edit)
	class UParticleSystemComponent*                    InUseParticleComponent;                                   // 0x057C(0x0004) (Edit, ExportObject, Component, EditInline)
	class USoundCue*                                   NotAllowedToPortalSound;                                  // 0x0580(0x0004) (Edit)
	class UTextureRenderTarget2D*                      PortalTextureTargets[0x2];                                // 0x0584(0x0004) (Transient)
	class UPointLightComponent*                        MyLightComp;                                              // 0x058C(0x0004) (ExportObject, Component, EditInline)
	float                                              LastFireTimes[0x2];                                       // 0x0590(0x0004)
	class UAnimNodePlayCustomAnim*                     CustomAnimNode;                                           // 0x0598(0x0004)
	class ADunDefPortalNode*                           PortalNodes[0x2];                                         // 0x059C(0x0004) (Net, Transient)
	int                                                CurrentAmmo;                                              // 0x05A4(0x0004) (Net)
	float                                              LastRegenTime;                                            // 0x05A8(0x0004) (Transient)
