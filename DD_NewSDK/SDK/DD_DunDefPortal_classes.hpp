...
public:
	...
	struct FName                                       PrimaryShootAnimName;                                     // 0x051C(0x0008) (Edit)
	struct FName                                       AltShootAnimName;                                         // 0x0524(0x0008) (Edit)
	struct FName                                       PrimaryCancelAnimName;                                    // 0x052C(0x0008) (Edit)
	struct FName                                       AltCancelAnimName;                                        // 0x0534(0x0008) (Edit)
	class ADunDefPortalNode*                           PortalNodeTemplates[0x2];                                 // 0x053C(0x0004) (Edit)
	class AActor*                                      AltTemplate;                                              // 0x0544(0x0004) (Edit)
	float                                              PortalFireInterval;                                       // 0x0548(0x0004) (Edit)
	float                                              PortalKillRadius;                                         // 0x054C(0x0004) (Edit)
	float                                              AmmoRegenInterval;                                        // 0x0550(0x0004) (Edit)
	float                                              AmmoRegenAmount;                                          // 0x0554(0x0004) (Edit)
	float                                              AmmoConsumeInterval;                                      // 0x0558(0x0004) (Edit)
	float                                              AmmoConsumeAmount;                                        // 0x055C(0x0004) (Edit)
	float                                              FullDrainRegenTimePenalty;                                // 0x0560(0x0004) (Edit)
	struct FLinearColor                                PrimaryFireColor;                                         // 0x0564(0x0010) (Edit)
	struct FLinearColor                                AltFireColor;                                             // 0x0574(0x0010) (Edit)
	struct FColor                                      PrimaryFireLightColor;                                    // 0x0584(0x0004) (Edit)
	struct FColor                                      AltFireLightColor;                                        // 0x0588(0x0004) (Edit)
	class UParticleSystemComponent*                    InUseParticleComponent;                                   // 0x058C(0x0004) (Edit, ExportObject, Component, EditInline)
	class USoundCue*                                   NotAllowedToPortalSound;                                  // 0x0590(0x0004) (Edit)
	class UTextureRenderTarget2D*                      PortalTextureTargets[0x2];                                // 0x0594(0x0004) (Transient)
	class UPointLightComponent*                        MyLightComp;                                              // 0x059C(0x0004) (ExportObject, Component, EditInline)
	float                                              LastFireTimes[0x2];                                       // 0x05A0(0x0004)
	class UAnimNodePlayCustomAnim*                     CustomAnimNode;                                           // 0x05A8(0x0004)
	class ADunDefPortalNode*                           PortalNodes[0x2];                                         // 0x05AC(0x0004) (Net, Transient)
	int                                                CurrentAmmo;                                              // 0x05B4(0x0004) (Net)
	float                                              LastRegenTime;                                            // 0x05B8(0x0004) (Transient)
