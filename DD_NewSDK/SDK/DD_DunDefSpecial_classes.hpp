...
public:
	...
	class ADunDefEmitterSpawnable*                     AbilityActivateTemplate;                                  // 0x0484(0x0004) (Edit)
	class USoundCue*                                   AbilityActivateSound;                                     // 0x0488(0x0004) (Edit)
	class USoundCue*                                   AbilityDeActivateSound;                                   // 0x048C(0x0004) (Edit)
	struct FStatMultipliers                            GroundSpeed;                                              // 0x0490(0x0010) (Edit)
	struct FStatMultipliers                            AttackDamage;                                             // 0x04A0(0x0010) (Edit)
	struct FStatMultipliers                            AttackSpeed;                                              // 0x04B0(0x0010) (Edit)
	struct FStatMultipliers                            AttackKnockBack;                                          // 0x04C0(0x0010) (Edit)
	struct FStatMultipliers                            MomentumMultiplier;                                       // 0x04D0(0x0010) (Edit)
	struct FStatMultipliers                            DamageResistance;                                         // 0x04E0(0x0010) (Edit)
	unsigned long                                      ReducePetDamageWhileUnderEffect : 1;                      // 0x04F0(0x0004) (Edit)
	unsigned long                                      bAllowActivateWhileCasting : 1;                           // 0x04F0(0x0004) (Edit)
	unsigned long                                      bCancelAllStancesOnActivate : 1;                          // 0x04F0(0x0004) (Edit)
	unsigned long                                      bCancelTornadoStanceOnActivate : 1;                       // 0x04F0(0x0004) (Edit)
	unsigned long                                      bCancelTurtleStanceOnActivate : 1;                        // 0x04F0(0x0004) (Edit)
	unsigned long                                      bCancelHawkStanceOnActivate : 1;                          // 0x04F0(0x0004) (Edit)
	unsigned long                                      bIsTurtleStance : 1;                                      // 0x04F0(0x0004) (Edit)
	unsigned long                                      bIsTornadoStance : 1;                                     // 0x04F0(0x0004) (Edit)
	unsigned long                                      bIsHawkStance : 1;                                        // 0x04F0(0x0004) (Edit)
	unsigned long                                      bAllowAttackStepTowards : 1;                              // 0x04F0(0x0004) (Edit)
	unsigned long                                      bNullifyJumpModifier : 1;                                 // 0x04F0(0x0004) (Edit)
	unsigned long                                      bStatusActive : 1;                                        // 0x04F0(0x0004)
	TEnumAsByte<EStances>                              myStance;                                                 // 0x04F4(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x04F5(0x0003) MISSED OFFSET
	struct FName                                       activeEffectSocket;                                       // 0x04F8(0x0008) (Edit)
	struct FName                                       StanceDeactivateAnim;                                     // 0x0500(0x0008) (Edit)
	struct FName                                       StanceActivateAnim;                                       // 0x0508(0x0008) (Edit)
	float                                              JumpZMultiplier;                                          // 0x0510(0x0004) (Edit)
	float                                              AttackKnockBackMomentumBase;                              // 0x0514(0x0004) (Edit)
...
{
public:
	class ACTF_Flag*                                   PickUpFlag;                                               // 0x046C(0x0004) (Net)
	class USoundCue*                                   StartPickingupSound;                                      // 0x0470(0x0004) (Edit)
...
{
public:
	class ADunDefPickupableItem*                       PickupItem;                                               // 0x046C(0x0004) (Net)
	class USoundCue*                                   StartPickingupSound;                                      // 0x0470(0x0004) (Edit)
...
// 0x00B4 (0x04E4 - 0x0430)
class ADunDefPlayerAbility_LeapSlam : public ADunDefPlayerAbility
{
public:
	float                                              LeapHeight;                                               // 0x0430(0x0004) (Edit)
	float                                              LeapSpeed;                                                // 0x0434(0x0004) (Edit)
	float                                              LeapRotationSpeed;                                        // 0x0438(0x0004) (Edit)
	int                                                ManaCostToActivate;                                       // 0x043C(0x0004) (Edit)
	float                                              MaxLeapDistance;                                          // 0x0440(0x0004) (Edit)
	struct FName                                       LeapStartAnim;                                            // 0x0444(0x0008) (Edit)
	struct FName                                       LeapLoopAnim;                                             // 0x044C(0x0008) (Edit)
	struct FName                                       LeapStopAnim;                                             // 0x0454(0x0008) (Edit)
	class ADunDefEmitterDamage*                        ShockwaveTemplate;                                        // 0x045C(0x0004) (Edit)
	struct FVector                                     LeapExtent;                                               // 0x0460(0x000C) (Edit)
	float                                              MassMomentumExponentialScale;                             // 0x046C(0x0004) (Edit)
	float                                              WeaponDamageMultiplier;                                   // 0x0470(0x0004) (Edit)
	float                                              AdditionalDamageAmount;                                   // 0x0474(0x0004) (Edit)
	float                                              HeroStatDamageModifierExponent;                           // 0x0478(0x0004) (Edit)
	float                                              MeleeDamageMomentum;                                      // 0x047C(0x0004) (Edit)
	float                                              HeroStatMomentumModifierExponent;                         // 0x0480(0x0004) (Edit)
	float                                              velocityInterp;                                           // 0x0484(0x0004) (Edit)
	float                                              AirTargetLeapStopDistance;                                // 0x0488(0x0004) (Edit)
	unsigned long                                      bRequiresAutoAimTarget : 1;                               // 0x048C(0x0004) (Edit)
	unsigned long                                      bStartedLeap : 1;                                         // 0x048C(0x0004)
	unsigned long                                      bStartDamage : 1;                                         // 0x048C(0x0004)
	unsigned long                                      bStopped : 1;                                             // 0x048C(0x0004) (Net)
	float                                              leapTimeOut;                                              // 0x0490(0x0004) (Edit)
	struct FString                                     NotAutoAimTargetFailString;                               // 0x0494(0x000C) (Edit, Localized, NeedCtorLink)
	float                                              HomingScale;                                              // 0x04A0(0x0004) (Edit)
	class AActor*                                      TargetActor;                                              // 0x04A4(0x0004)
	struct FVector                                     originalTargetLoc;                                        // 0x04A8(0x000C)
	TArray<struct ADunDefPlayerAbility_LeapSlam_FHitTarget> HitTargets;                                               // 0x04B4(0x000C) (NeedCtorLink)
	class ADunDefEmitterSpawnable*                     WeaponEmitterTemplate;                                    // 0x04C0(0x0004) (Edit)
	class UParticleSystemComponent*                    MyParticleSystemComponent;                                // 0x04C4(0x0004) (Edit, ExportObject, Component, EditInline)
	struct FVector                                     lastStuckCheck;                                           // 0x04C8(0x000C) (Transient)
	float                                              hitWallTraceOffset;                                       // 0x04D4(0x0004) (Edit)
	float                                              StuckCheckInterval;                                       // 0x04D8(0x0004) (Edit)
	float                                              StuckCheckDistance;                                       // 0x04DC(0x0004) (Edit)
	class UClass*                                      MyDamageType;                                             // 0x04E0(0x0004) (Edit)
...
// 0x0114 (0x0594 - 0x0480)
class ADunDefPlayerAbility_ManaCharge : public ADunDefPlayerAbility_CharacterToggle
{
public:
	int                                                currentManaCharge;                                        // 0x0480(0x0004) (Net)
	float                                              MinShootTime;                                             // 0x0484(0x0004) (Edit)
	float                                              MaxShootTime;                                             // 0x0488(0x0004) (Edit)
	int                                                MaxAllowedManaCharge;                                     // 0x048C(0x0004) (Edit)
	int                                                MinAllowedManaCharge;                                     // 0x0490(0x0004) (Edit)
	float                                              DamageProcInterval;                                       // 0x0494(0x0004) (Edit)
	float                                              BeamDamageMomentum;                                       // 0x0498(0x0004) (Edit)
	float                                              DamageMultiplier;                                         // 0x049C(0x0004) (Edit)
	float                                              DamageExponent;                                           // 0x04A0(0x0004) (Edit)
	float                                              ManaTimeExponent;                                         // 0x04A4(0x0004) (Edit)
	float                                              ChargeBarExponent;                                        // 0x04A8(0x0004) (Edit)
	float                                              BeamRange;                                                // 0x04AC(0x0004) (Edit)
	struct FName                                       ChargingAnim;                                             // 0x04B0(0x0008) (Edit)
	struct FName                                       ReleasingAnim;                                            // 0x04B8(0x0008) (Edit)
	struct FName                                       MuzzleSocketName;                                         // 0x04C0(0x0008) (Edit)
	class UClass*                                      BeamDamageType;                                           // 0x04C8(0x0004) (Edit)
	class UParticleSystemComponent*                    BeamEffect;                                               // 0x04CC(0x0004) (Edit, ExportObject, Component, EditInline)
	class UParticleSystemComponent*                    MuzzleEffect;                                             // 0x04D0(0x0004) (Edit, ExportObject, Component, EditInline)
	class UParticleSystemComponent*                    BeamEndEffect;                                            // 0x04D4(0x0004) (Edit, ExportObject, Component, EditInline)
	class ADunDefEmitterSpawnable*                     ManaPickUpEffect;                                         // 0x04D8(0x0004) (Edit)
	float                                              TimeBetweenManaPickUpVFX;                                 // 0x04DC(0x0004) (Edit)
	float                                              LastManaPickUpTime;                                       // 0x04E0(0x0004)
	class UParticleSystemComponent*                    ChargeEffect;                                             // 0x04E4(0x0004) (Edit, ExportObject, Component, EditInline)
	class UMaterialInterface*                          ChargeBar;                                                // 0x04E8(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     ActivationEffect;                                         // 0x04EC(0x0004) (Edit)
	float                                              BarScale;                                                 // 0x04F0(0x0004) (Edit)
	float                                              ChargingManaAttractionRadiusMultiplier;                   // 0x04F4(0x0004) (Edit)
	float                                              BarXOffset;                                               // 0x04F8(0x0004) (Edit)
	float                                              BarYOffset;                                               // 0x04FC(0x0004) (Edit)
	float                                              BarIconSizeY;                                             // 0x0500(0x0004) (Edit)
	float                                              BarIconSizeX;                                             // 0x0504(0x0004) (Edit)
	struct FName                                       ManaGatherSocketName;                                     // 0x0508(0x0008) (Edit)
	struct FName                                       ManaChargeBarSocket;                                      // 0x0510(0x0008) (Edit)
	struct FVector                                     ChargeBarOffset;                                          // 0x0518(0x000C) (Edit)
	struct FRotator                                    ChargeBarRot;                                             // 0x0524(0x000C) (Edit)
	unsigned long                                      bUseCastBarForCharge : 1;                                 // 0x0530(0x0004) (Edit)
	unsigned long                                      bUseActivateAsToggleOnly : 1;                             // 0x0530(0x0004) (Edit)
	unsigned long                                      bDoingDamage : 1;                                         // 0x0530(0x0004) (Net)
	unsigned long                                      ScaleMomentumForPawnMass : 1;                             // 0x0530(0x0004) (Edit)
	struct FLinearColor                                ChargeBarColor;                                           // 0x0534(0x0010) (Edit)
	struct FLinearColor                                ChargeBarColorAllowActivate;                              // 0x0544(0x0010) (Edit)
	struct FString                                     NeedMoreManaChargeMsg;                                    // 0x0554(0x000C) (Edit, Localized, NeedCtorLink)
	struct FColor                                      NeedMoreManaMsgColor;                                     // 0x0560(0x0004) (Edit)
	class USoundCue*                                   BeginFiringSound;                                         // 0x0564(0x0004) (Edit)
	class USoundCue*                                   StopFiringSound;                                          // 0x0568(0x0004) (Edit)
	class UAudioComponent*                             LoopingFiringSound;                                       // 0x056C(0x0004) (Edit, ExportObject, Component, EditInline)
	float                                              LoopingFiringSoundFadeInTime;                             // 0x0570(0x0004) (Edit)
	float                                              LastBeamFireTime;                                         // 0x0574(0x0004) (Transient)
	class UMaterialInstanceConstant*                   chargeBarMIC;                                             // 0x0578(0x0004) (Transient)
	float                                              currentTimeLimit;                                         // 0x057C(0x0004)
	float                                              MaxPawnMassMomentumScale;                                 // 0x0580(0x0004) (Edit)
	float                                              ScaleMomentumForPawnMassExponent;                         // 0x0584(0x0004) (Edit)
	float                                              MinPawnMassMomentumScale;                                 // 0x0588(0x0004) (Edit)
	float                                              MaxTargetDeltaPitch;                                      // 0x058C(0x0004) (Edit)
	float                                              MaxTargetDeltaYaw;                                        // 0x0590(0x0004) (Edit)
...
public:
	class UParticleSystemComponent*                    AbilityEffectComponent;                                   // 0x0480(0x0004) (Edit, ExportObject, Component, EditInline)
	struct FName                                       UnPhasedScaleDown;                                        // 0x0484(0x0008) (Edit)
	struct FName                                       UnPhasedScaleUp;                                          // 0x048C(0x0008) (Edit)
	struct FName                                       PhasedScaleDown;                                          // 0x0494(0x0008) (Edit)
	struct FName                                       PhaseScaleUp;                                             // 0x049C(0x0008) (Edit)
	struct FLinearColor                                OverlayEffectColor;                                       // 0x04A4(0x0010) (Edit)
	float                                              ScaleTime;                                                // 0x04B4(0x0004) (Edit)
	float                                              ReScaleBackUpDelay;                                       // 0x04B8(0x0004) (Edit)
	unsigned long                                      bEndCastingStateOnScale : 1;                              // 0x04BC(0x0004) (Edit)
	unsigned long                                      bEnterCastingStateWhilePhased : 1;                        // 0x04BC(0x0004) (Edit)
	unsigned long                                      bScalingDown : 1;                                         // 0x04BC(0x0004) (Transient)
	unsigned long                                      bPendingScaleUp : 1;                                      // 0x04BC(0x0004) (Transient)
	unsigned long                                      bPendingScaleDown : 1;                                    // 0x04BC(0x0004) (Transient)
	unsigned long                                      bIgnoreCastingState : 1;                                  // 0x04BC(0x0004) (Transient)
	unsigned long                                      bIsPhased : 1;                                            // 0x04BC(0x0004) (Net)
	unsigned long                                      bUpScaling : 1;                                           // 0x04BC(0x0004)
	unsigned long                                      bScaling : 1;                                             // 0x04BC(0x0004)
	unsigned long                                      bUnphasing : 1;                                           // 0x04BC(0x0004) (Transient)
	unsigned long                                      bUnphased : 1;                                            // 0x04BC(0x0004) (Transient)
	float                                              InitialScale;                                             // 0x04C0(0x0004) (Transient)
	float                                              ScaleDownCompleteTime;                                    // 0x04C4(0x0004) (Transient)
	TArray<class UMaterialInstanceConstant*>           myOriginalMICs;                                           // 0x04C8(0x000C) (Transient, NeedCtorLink)
	TArray<class UMaterialInstanceConstant*>           myMICOverride;                                            // 0x04D4(0x000C) (Transient, NeedCtorLink)
...
// 0x0064 (0x0780 - 0x071C)
class ADunDefPlayerAbility_BuilTripWire : public ADunDefPlayerAbility_BuildTower
{
public:
	int                                                PlacementPoints;                                          // 0x071C(0x0004) (Edit)
	unsigned long                                      bCheckLineOfSight : 1;                                    // 0x0720(0x0004) (Edit)
	struct FString                                     LineofSightBlockString;                                   // 0x0724(0x000C) (Edit, Localized, NeedCtorLink)
	float                                              DUTextScale;                                              // 0x0730(0x0004) (Edit)
	float                                              MinPointPlacementDistance;                                // 0x0734(0x0004) (Edit)
	struct FVector                                     DUStringOffset;                                           // 0x0738(0x000C) (Edit)
	struct FString                                     DUPlacementString;                                        // 0x0744(0x000C) (Edit, Localized, NeedCtorLink)
	TArray<class UClass*>                              CancelsLineOfSightClass;                                  // 0x0750(0x000C) (Edit, NeedCtorLink)
	class UParticleSystemComponent*                    PreviewBeamEffect;                                        // 0x075C(0x0004) (Edit, ExportObject, Component, EditInline)
	struct FVector                                     LineofSightExtent;                                        // 0x0760(0x000C) (Edit)
	class ADunDefEmitterSpawnable*                     MyAltSummoningEmitter;                                    // 0x076C(0x0004) (Transient)
	float                                              MaxTowerDistance;                                         // 0x0770(0x0004)
	TArray<struct FPreviewPoint>                       PreviewPoints;                                            // 0x0774(0x000C) (Component, NeedCtorLink)
...
// 0x0030 (0x050C - 0x04DC)
class ADunDefPlayerAbility_DefenseBoost : public ADunDefPlayerAbility_AreaOfEffect
{
public:
	TArray<TEnumAsByte<ETowerBoostType>>               MyTowerBoostType;                                         // 0x04DC(0x000C) (Edit, NeedCtorLink)
	float                                              ETBAttackRateExponent;                                    // 0x04E8(0x0004) (Edit)
	float                                              ETBAttackRangeExponent;                                   // 0x04EC(0x0004) (Edit)
	float                                              ETBDamageExponent;                                        // 0x04F0(0x0004) (Edit)
	float                                              TowerDamageMultiplier;                                    // 0x04F4(0x0004) (Edit)
	float                                              TowerRangeMultiplier;                                     // 0x04F8(0x0004) (Edit)
	float                                              TowerRateMultiplier;                                      // 0x04FC(0x0004) (Edit)
	TArray<struct FAffectedActor>                      BoostedTowers;                                            // 0x0500(0x000C) (Component, NeedCtorLink)
...
{
public:
	float                                              DamageScalar;                                             // 0x04DC(0x0004) (Edit)
	float                                              DamageResistanceMultiplier;                               // 0x04E0(0x0004) (Edit)
	float                                              SpeedMultiplier;                                          // 0x04E4(0x0004) (Edit)
	float                                              DamageExponent;                                           // 0x04E8(0x0004) (Edit)
	float                                              DamageResistanceExponent;                                 // 0x04EC(0x0004) (Edit)
	float                                              SpeedExponent;                                            // 0x04F0(0x0004) (Edit)
...
// 0x0008 (0x04E4 - 0x04DC)
class ADunDefPlayerAbility_InstantUpgradeTower : public ADunDefPlayerAbility_AreaOfEffect
{
public:
	float                                              TowerUpgradeScale;                                        // 0x04DC(0x0004) (Edit)
	float                                              ExpTowerUpgradeScale;                                     // 0x04E0(0x0004) (Edit)
...
{
public:
	float                                              NewTowerTargetableAttackRange;                            // 0x04DC(0x0004) (Edit)
	float                                              HeroStatGroundSpeedExponent;                              // 0x04E0(0x0004) (Edit)
...
// 0x0170 (0x06B4 - 0x0544)
class ADunDefPlayerAbility_MoveTower : public ADunDefPlayerAbility_TowerPlacement
{
public:
	class UMaterialInstanceConstant*                   DecalMaterialMoveTower;                                   // 0x0544(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     ChoosingTowerWeaponEmitter;                               // 0x0548(0x0004) (Edit)
	class UTexture2D*                                  CursorSelectTexture;                                      // 0x054C(0x0004) (Edit)
	class UTexture2D*                                  CursorMoveTexture;                                        // 0x0550(0x0004) (Edit)
	class USkeletalMeshComponent*                      TowerMeshComponent;                                       // 0x0554(0x0004) (Edit, ExportObject, Component, EditInline)
	float                                              MinimumNormalZForPlacement;                               // 0x0558(0x0004) (Edit)
	float                                              MinimumRotationInputDistance;                             // 0x055C(0x0004) (Edit)
	TArray<struct FVector>                             TraceDirections;                                          // 0x0560(0x000C) (Edit, NeedCtorLink)
	struct FVector                                     TraceExtent;                                              // 0x056C(0x000C) (Edit)
	struct FVector                                     RotationGamepadCursorOffset;                              // 0x0578(0x000C) (Edit)
	struct FVector                                     PlacementRotationCursorOffset;                            // 0x0584(0x000C) (Edit)
	struct FVector                                     ExtentCheckBaseOffset;                                    // 0x0590(0x000C) (Edit)
	float                                              RotationCursorScale;                                      // 0x059C(0x0004) (Edit)
	class UTexture2D*                                  CursorRotateTexture;                                      // 0x05A0(0x0004) (Edit)
	float                                              PlacementLightIntensityMultiplier;                        // 0x05A4(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     MovementEffect;                                           // 0x05A8(0x0004) (Edit)
	class UMaterialInterface*                          MeshPlacementMaterial;                                    // 0x05AC(0x0004) (Edit)
	float                                              AutoTowerPlacementMeshScaleBase;                          // 0x05B0(0x0004) (Edit)
	float                                              OtherAbilityPreventionRadiusBuffer;                       // 0x05B4(0x0004) (Edit)
	float                                              OtherAbilityPreventionRadiusMultiplier;                   // 0x05B8(0x0004) (Edit)
	class UStaticMeshComponent*                        rangeMesh;                                                // 0x05BC(0x0004) (Edit, ExportObject, Component, EditInline)
	class USkeletalMesh*                               TrapPreviewMesh;                                          // 0x05C0(0x0004) (Edit)
	struct FVector                                     TrapMeshScaleVec;                                         // 0x05C4(0x000C) (Edit)
	TArray<struct FString>                             PlacementDeniedStrings;                                   // 0x05D0(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     ChooseWhereToPlaceString;                                 // 0x05DC(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     ChooseTowerString;                                        // 0x05E8(0x000C) (Edit, Localized, NeedCtorLink)
	float                                              TrapZOffset;                                              // 0x05F4(0x0004) (Edit)
	float                                              AngleIndicatorDecalSize;                                  // 0x05F8(0x0004) (Edit)
	struct FVector                                     AngleIndicatorDecalOffset;                                // 0x05FC(0x000C) (Edit)
	class UMaterialInstanceConstant*                   AngleIndicatorDecalMaterial_361;                          // 0x0608(0x0004) (Edit)
	class UMaterialInstanceConstant*                   AngleIndicatorDecalMaterial_121;                          // 0x060C(0x0004) (Edit)
	class UMaterialInstanceConstant*                   AngleIndicatorDecalMaterial_91;                           // 0x0610(0x0004) (Edit)
	class UMaterialInstanceConstant*                   AngleIndicatorDecalMaterial_31;                           // 0x0614(0x0004) (Edit)
	class UMaterialInstanceConstant*                   RangeIndicatorDecalMaterial_361;                          // 0x0618(0x0004) (Edit)
	class UMaterialInstanceConstant*                   RangeIndicatorDecalMaterial_121;                          // 0x061C(0x0004) (Edit)
	class UMaterialInstanceConstant*                   RangeIndicatorDecalMaterial_91;                           // 0x0620(0x0004) (Edit)
	class UMaterialInstanceConstant*                   RangeIndicatorDecalMaterial_31;                           // 0x0624(0x0004) (Edit)
	float                                              AngleIndicatorDecalTowerRangeScale;                       // 0x0628(0x0004) (Edit)
	float                                              baseRangeMeshScale;                                       // 0x062C(0x0004) (Edit)
	float                                              PlacementRangeExponent;                                   // 0x0630(0x0004) (Edit)
	float                                              ManaCostToActivate;                                       // 0x0634(0x0004) (Edit)
	class UDecalComponent*                             AngleIndicatorDecal;                                      // 0x0638(0x0004) (ExportObject, Component, EditInline)
	class UDecalComponent*                             RangeIndicatorDecal;                                      // 0x063C(0x0004) (ExportObject, Component, EditInline)
	class UMaterialInstanceConstant*                   AngleIndicatorDecalMaterialInstance;                      // 0x0640(0x0004) (Transient)
	class UMaterialInstanceConstant*                   RangeIndicatorDecalMaterialInstance;                      // 0x0644(0x0004) (Transient)
	struct FVector                                     TowerActorPlacementOffset;                                // 0x0648(0x000C)
	struct FVector                                     ReplicatedPlacementLocation;                              // 0x0654(0x000C) (Net)
	struct FRotator                                    ReplicatedPlacementRotation;                              // 0x0660(0x000C) (Net)
	unsigned long                                      ReplicatedIsValidPlacement : 1;                           // 0x066C(0x0004) (Net)
	unsigned long                                      bWasValidTower : 1;                                       // 0x066C(0x0004) (Transient)
	unsigned long                                      bShowAngleDecal : 1;                                      // 0x066C(0x0004) (Transient)
	unsigned long                                      bShowRangeDecal : 1;                                      // 0x066C(0x0004) (Transient)
	unsigned long                                      bClientGotoRotationState : 1;                             // 0x066C(0x0004) (Transient)
	unsigned long                                      ClientForceNoInterpolation : 1;                           // 0x066C(0x0004) (Transient)
	float                                              LastTowerMeshScale;                                       // 0x0670(0x0004) (Transient)
	float                                              TowerRangeScaler;                                         // 0x0674(0x0004) (Net, Transient)
	float                                              TowerMeshScale;                                           // 0x0678(0x0004)
	float                                              CurrentAngleDecalOpacity;                                 // 0x067C(0x0004)
	class ADunDefTower*                                currentMovingTower;                                       // 0x0680(0x0004)
	class ADunDefTower*                                pendingMovingTower;                                       // 0x0684(0x0004) (Transient)
	class UParticleSystem*                             defaultParticleTemplate;                                  // 0x0688(0x0004) (Transient)
	struct FVector                                     GamepadLookDirection;                                     // 0x068C(0x000C) (Transient)
	struct FRotator                                    PlacementRotation;                                        // 0x0698(0x000C) (Transient)
	struct FVector                                     LookAtLocation;                                           // 0x06A4(0x000C) (Transient)
	class UMaterialInstanceConstant*                   MeshMaterialInstance;                                     // 0x06B0(0x0004) (Transient)
...
public:
	...
	float                                              SelectionRadius;                                          // 0x0548(0x0004) (Edit)
	class UDecalComponent*                             SummonRangeDecal;                                         // 0x054C(0x0004) (Edit, ExportObject, Component, EditInline)
	class UMaterialInstanceConstant*                   SummonRangeIndicatorDecalMaterial;                        // 0x0550(0x0004) (Edit)
	struct FVector                                     SummonIndicatorDecalOffset;                               // 0x0554(0x000C) (Edit)
	unsigned long                                      bRequiresMovementLocation : 1;                            // 0x0560(0x0004) (Edit)
	unsigned long                                      bTraceForTarget : 1;                                      // 0x0560(0x0004) (Edit)
	unsigned long                                      bForceMaualInOverlord : 1;                                // 0x0560(0x0004) (Edit)
	unsigned long                                      bDoInstantCommand : 1;                                    // 0x0560(0x0004) (Edit)
	unsigned long                                      bUseInstigatorAsTargetedActor : 1;                        // 0x0560(0x0004) (Edit)
	unsigned long                                      bOnlyTargetFriendly : 1;                                  // 0x0560(0x0004) (Edit)
	unsigned long                                      bUsePlayersTarget : 1;                                    // 0x0560(0x0004) (Edit)
	unsigned long                                      bRequiresSelections : 1;                                  // 0x0560(0x0004) (Edit)
	TEnumAsByte<ESummonedCommand>                      myCommand;                                                // 0x0564(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0565(0x0003) MISSED OFFSET
	class UTexture2D*                                  targetedIcon;                                             // 0x0568(0x0004) (Edit)
	struct FVector                                     TargetedIconOffset;                                       // 0x056C(0x000C) (Edit)
	float                                              targetedIconSize;                                         // 0x0578(0x0004) (Edit)
	float                                              SelectRadius;                                             // 0x057C(0x0004) (Edit)
	float                                              placementSteps;                                           // 0x0580(0x0004) (Edit)
	float                                              placementRadius;                                          // 0x0584(0x0004) (Edit)
	float                                              placementIncrease;                                        // 0x0588(0x0004) (Edit)
	int                                                placementIterations;                                      // 0x058C(0x0004) (Edit)
	struct FName                                       IssueCommandAnimName;                                     // 0x0590(0x0008) (Edit)
	struct FName                                       CommandFinishAnim;                                        // 0x0598(0x0008) (Edit)
	class ADunDefEmitterSpawnable*                     Blip_MoveEmitter;                                         // 0x05A0(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     Blip_Follow;                                              // 0x05A4(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     Blip_AttackEmitter;                                       // 0x05A8(0x0004) (Edit)
	class USoundCue*                                   LocalIssueCommandSound;                                   // 0x05AC(0x0004) (Edit)
	struct FString                                     RequiresMinionsString;                                    // 0x05B0(0x000C) (Edit, Localized, NeedCtorLink)
	class UAudioComponent*                             OrderIssuedUnitCommand;                                   // 0x05BC(0x0004) (ExportObject, Component, EditInline)
	class AActor*                                      targetedActor;                                            // 0x05C0(0x0004) (Transient)
	class ADunDefPlayer_Summoner*                      mySummoner;                                               // 0x05C4(0x0004) (Transient)
	float                                              SelectionRangeScaler;                                     // 0x05C8(0x0004) (Transient)
	class UMaterialInstanceConstant*                   SummonRangeIndicatorDecalMaterialInstance;                // 0x05CC(0x0004) (Transient)
...
{
public:
	class ADunDefEmitterSpawnable*                     Blip_MoveEmitter;                                         // 0x04E0(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     Blip_Follow;                                              // 0x04E4(0x0004) (Edit)
	class ADunDefEmitterSpawnable*                     Blip_AttackEmitter;                                       // 0x04E8(0x0004) (Edit)
	class UTexture2D*                                  overFriendly;                                             // 0x04EC(0x0004) (Edit)
	class UTexture2D*                                  overEnemy;                                                // 0x04F0(0x0004) (Edit)
	class UTexture2D*                                  overFollow;                                               // 0x04F4(0x0004) (Edit)
	float                                              mouseOverIconScale;                                       // 0x04F8(0x0004) (Edit)
	struct FColor                                      overEnemyColor;                                           // 0x04FC(0x0004) (Edit)
	struct FColor                                      overFriendlyColor;                                        // 0x0500(0x0004) (Edit)
	float                                              moveLocRadius;                                            // 0x0504(0x0004) (Edit)
	float                                              placementSteps;                                           // 0x0508(0x0004) (Edit)
	float                                              placementRadius;                                          // 0x050C(0x0004) (Edit)
	float                                              placementIncrease;                                        // 0x0510(0x0004) (Edit)
	int                                                placementIterations;                                      // 0x0514(0x0004) (Edit)
	class USoundCue*                                   MovementClickSound;                                       // 0x0518(0x0004) (Edit)
	class USoundCue*                                   AttackSound;                                              // 0x051C(0x0004) (Edit)
	class USoundCue*                                   FollowSound;                                              // 0x0520(0x0004) (Edit)
	class USoundCue*                                   SelectSound;                                              // 0x0524(0x0004) (Edit)
	class USoundCue*                                   DeSelectSound;                                            // 0x0528(0x0004) (Edit)
	struct FName                                       UnphasingCastingStateName;                                // 0x052C(0x0008) (Edit)
	struct FString                                     UnsupportedGamepadString;                                 // 0x0534(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     SelectMinionsString;                                      // 0x0540(0x000C) (Edit, Localized, NeedCtorLink)
	unsigned long                                      bDrawStringPrompt : 1;                                    // 0x054C(0x0004) (Edit)
	unsigned long                                      bSelectionStarted : 1;                                    // 0x054C(0x0004) (Transient)
	unsigned long                                      bForceCancel : 1;                                         // 0x054C(0x0004) (Transient)
	float                                              BlipZOffset;                                              // 0x0550(0x0004) (Edit)
	struct FVector2D                                   startMouseCoords;                                         // 0x0554(0x0008) (Transient)
	struct FVector                                     startMouseProjection;                                     // 0x055C(0x000C) (Transient)
	struct FVector                                     startMouseDirection;                                      // 0x0568(0x000C) (Transient)
	TArray<class ADunDefTower_SummonEnemy*>            currentSelectedTowers;                                    // 0x0574(0x000C) (Transient, NeedCtorLink)
	class AActor*                                      currentMousedActor;                                       // 0x0580(0x0004) (Transient)
	float                                              clickStart;                                               // 0x0584(0x0004) (Transient)
	struct FColor                                      LineColor;                                                // 0x0588(0x0004) (Edit)
	class ADunDefDroppedEquipment*                     MovingItem;                                               // 0x058C(0x0004) (Transient)
	struct FVector                                     MovingItemStartLocation;                                  // 0x0590(0x000C) (Transient)
	float                                              MovingItemZOffset;                                        // 0x059C(0x0004) (Transient)
	float                                              MovingItemZOffsetAdditional;                              // 0x05A0(0x0004) (Edit)
	float                                              MovingItemZOffsetMinimum;                                 // 0x05A4(0x0004) (Edit)
...
// 0x0064 (0x05A8 - 0x0544)
class ADunDefPlayerAbility_SelectSummonUnits : public ADunDefPlayerAbility_TowerPlacement
{
public:
	class UMaterialInstanceConstant*                   DecalMaterialBuild;                                       // 0x0544(0x0004) (Edit)
	float                                              SelectionRadius;                                          // 0x0548(0x0004) (Edit)
	float                                              DecalRangeScale;                                          // 0x054C(0x0004) (Edit)
	TArray<class ADunDefTower_SummonEnemy*>            currentSelectedTowers;                                    // 0x0550(0x000C) (NeedCtorLink)
	class UDecalComponent*                             SummonRangeDecal;                                         // 0x055C(0x0004) (Edit, ExportObject, Component, EditInline)
	class UMaterialInstanceConstant*                   SummonRangeIndicatorDecalMaterial;                        // 0x0560(0x0004) (Edit)
	struct FVector                                     SummonIndicatorDecalOffset;                               // 0x0564(0x000C) (Edit)
	unsigned long                                      bRequiresMovementLocation : 1;                            // 0x0570(0x0004) (Edit)
	unsigned long                                      DeselectAllTower : 1;                                     // 0x0570(0x0004) (Edit)
	unsigned long                                      bSelectAllTowers : 1;                                     // 0x0570(0x0004) (Edit)
	struct FName                                       SelectingAnimName;                                        // 0x0574(0x0008) (Edit)
	struct FName                                       SelectingStopAnim;                                        // 0x057C(0x0008) (Edit)
	struct FString                                     SelectUnitsString;                                        // 0x0584(0x000C) (Edit, Localized, NeedCtorLink)
	class USoundCue*                                   SelectSound;                                              // 0x0590(0x0004) (Edit)
	class USoundCue*                                   DeSelectSound;                                            // 0x0594(0x0004) (Edit)
	class ADunDefPlayer_Summoner*                      mySummoner;                                               // 0x0598(0x0004) (Transient)
	float                                              SelectionRangeScaler;                                     // 0x059C(0x0004) (Transient)
	class UMaterialInstanceConstant*                   SummonRangeIndicatorDecalMaterialInstance;                // 0x05A0(0x0004) (Transient)
	float                                              LastConfirmTime;                                          // 0x05A4(0x0004) (Transient)
...
{
public:
	TArray<struct ADunDefPlayerAbility_SlamDash_FHitTarget> HitTargets;                                               // 0x0480(0x000C) (NeedCtorLink)
	float                                              DamageInterval;                                           // 0x048C(0x0004) (Edit)
	float                                              MaxActiveTime;                                            // 0x0490(0x0004) (Edit)
	float                                              MeleeDamageMomentum;                                      // 0x0494(0x0004) (Edit)
	struct FVector                                     MeleeSwingExtent;                                         // 0x0498(0x000C) (Edit)
	float                                              MassMomentumExponentialScale;                             // 0x04A4(0x0004) (Edit)
	float                                              WeaponDamageMultiplier;                                   // 0x04A8(0x0004) (Edit)
	float                                              AdditionalDamageAmount;                                   // 0x04AC(0x0004) (Edit)
	float                                              HeroStatDamageModifierExponent;                           // 0x04B0(0x0004) (Edit)
	float                                              HeroStatMomentumModifierExponent;                         // 0x04B4(0x0004) (Edit)
	float                                              DashAnimPlayRate;                                         // 0x04B8(0x0004) (Edit)
	float                                              DashGroundSpeed;                                          // 0x04BC(0x0004) (Edit)
	float                                              HeroStatGroundSpeedExponent;                              // 0x04C0(0x0004) (Edit)
	float                                              PushRadius;                                               // 0x04C4(0x0004) (Edit)
	float                                              PlayRateExp;                                              // 0x04C8(0x0004) (Edit)
	float                                              MaxPlayRate;                                              // 0x04CC(0x0004) (Edit)
	float                                              MaxTravelDistance;                                        // 0x04D0(0x0004) (Edit)
	struct FVector                                     RunStartPoint;                                            // 0x04D4(0x000C)
	struct FName                                       DashStartAnim;                                            // 0x04E0(0x0008) (Edit)
	struct FName                                       DashLoopAnim;                                             // 0x04E8(0x0008) (Edit)
	struct FName                                       DashStopAnim;                                             // 0x04F0(0x0008) (Edit)
	class ADunDefEmitterSpawnable*                     WeaponEmitterTemplate;                                    // 0x04F8(0x0004) (Edit)
	class UParticleSystemComponent*                    MyParticleSystemComponent;                                // 0x04FC(0x0004) (Edit, ExportObject, Component, EditInline)
	unsigned long                                      bStopped : 1;                                             // 0x0500(0x0004) (Net)
	unsigned long                                      bStartedDash : 1;                                         // 0x0500(0x0004)
	unsigned long                                      SummoningFlameLine : 1;                                   // 0x0500(0x0004)
	struct FVector                                     lastStuckCheck;                                           // 0x0504(0x000C) (Transient)
	float                                              hitWallTraceOffset;                                       // 0x0510(0x0004) (Edit)
	float                                              StuckCheckInterval;                                       // 0x0514(0x0004) (Edit)
	float                                              StuckCheckDistance;                                       // 0x0518(0x0004) (Edit)
	class UClass*                                      MyDamageType;                                             // 0x051C(0x0004) (Edit)
	class ADunDefGasCloud*                             FlameCloudTemplate;                                       // 0x0520(0x0004) (Edit)
	float                                              SummonFlameInterval;                                      // 0x0524(0x0004) (Edit)
	struct FVector                                     FlameOffset;                                              // 0x0528(0x000C) (Edit)
	float                                              LastSummonFlameLineTime;                                  // 0x0534(0x0004)
...
{
public:
	unsigned long                                      bDoStun : 1;                                              // 0x0518(0x0004) (Edit)
	unsigned long                                      bHealthAsDmg : 1;                                         // 0x0518(0x0004) (Edit)
	unsigned long                                      bLimitHealAmtPerAttack : 1;                               // 0x0518(0x0004) (Edit)
	unsigned long                                      bBaseHealOnOwnerHealth : 1;                               // 0x0518(0x0004) (Edit)
	unsigned long                                      bUseHealAmtforPerAttack : 1;                              // 0x0518(0x0004) (Edit)
	unsigned long                                      bIgnoreMaxHealAmt : 1;                                    // 0x0518(0x0004) (Edit)
	struct FStatMultipliers                            HealOnHitMult;                                            // 0x051C(0x0010) (Edit)
	class UClass*                                      dmgType;                                                  // 0x052C(0x0004) (Edit)
	float                                              MinHealAmtPct;                                            // 0x0530(0x0004) (Edit)
	float                                              MaxHealAmtPctPerAttack;                                   // 0x0534(0x0004) (Edit)
	int                                                BaseHealAmount;                                           // 0x0538(0x0004) (Edit)
	int                                                MinHealAmount;                                            // 0x053C(0x0004) (Edit)
	int                                                MaxNumProcs;                                              // 0x0540(0x0004) (Edit)
	int                                                curNumProcs;                                              // 0x0544(0x0004)
	int                                                accumulatedHeal;                                          // 0x0548(0x0004)
	int                                                MaxHealAmtPerAttack;                                      // 0x054C(0x0004) (Edit)
...
// 0x0064 (0x05B4 - 0x0550)
class ADunDefPlayerAbility_StanceLightning : public ADunDefPlayerAbility_StanceOnDmgEffect
{
public:
	TArray<struct FStunnedActors>                      currentStunnedEnemies;                                    // 0x0550(0x000C) (Component, NeedCtorLink)
	TArray<struct FChainedActors>                      currentChainedActors;                                     // 0x055C(0x000C) (Component, NeedCtorLink)
	int                                                BaseChainRange;                                           // 0x0568(0x0004) (Edit)
	int                                                BaseChainTargets;                                         // 0x056C(0x0004) (Edit)
	float                                              ChainRangeExponent;                                       // 0x0570(0x0004) (Edit)
	struct FStatMultipliers                            StunTimeValue;                                            // 0x0574(0x0010) (Edit)
	struct FName                                       AttachEffectToPawnSocket;                                 // 0x0584(0x0008) (Edit)
	class USoundCue*                                   StunEnemySound;                                           // 0x058C(0x0004) (Edit)
	float                                              StunSoundDelay;                                           // 0x0590(0x0004) (Edit)
	float                                              LastStunSound;                                            // 0x0594(0x0004)
	class UParticleSystem*                             StunnedEffect;                                            // 0x0598(0x0004) (Edit)
	class UParticleSystem*                             ChainEffect;                                              // 0x059C(0x0004) (Edit)
	float                                              StunTime;                                                 // 0x05A0(0x0004) (Edit)
	unsigned long                                      bAllowBossStun : 1;                                       // 0x05A4(0x0004) (Edit)
	TArray<class UClass*>                              NoStunDamageTypes;                                        // 0x05A8(0x000C) (Edit, NeedCtorLink)
...
// 0x0044 (0x055C - 0x0518)
class ADunDefPlayerAbility_StanceSpecialAttack : public ADunDefPlayerAbility_StanceBase
{
public:
	struct FName                                       SpecialAnimation;                                         // 0x0518(0x0008) (Edit)
	struct FVector                                     MeleeSwingExtent;                                         // 0x0520(0x000C) (Edit)
	float                                              DamageMomentum;                                           // 0x052C(0x0004) (Edit)
	float                                              MassMomentumExponentialScale;                             // 0x0530(0x0004) (Edit)
	float                                              WeaponDamageMultiplier;                                   // 0x0534(0x0004) (Edit)
	float                                              AdditionalDamageAmount;                                   // 0x0538(0x0004) (Edit)
	float                                              HeroStatDamageModifierExponent;                           // 0x053C(0x0004) (Edit)
	float                                              HeroStatMomentumModifierExponent;                         // 0x0540(0x0004) (Edit)
	float                                              TimeBeforeEndAnimationToFinish;                           // 0x0544(0x0004) (Edit)
	float                                              CompletedStunDelayTime;                                   // 0x0548(0x0004) (Edit)
	unsigned long                                      bUseWeaponsIndividual : 1;                                // 0x054C(0x0004) (Edit)
	unsigned long                                      bUseCombinedDamage : 1;                                   // 0x054C(0x0004) (Edit)
	unsigned long                                      bLockStanceOnComplete : 1;                                // 0x054C(0x0004) (Edit)
	unsigned long                                      bAutoActivate : 1;                                        // 0x054C(0x0004) (Edit)
	unsigned long                                      bSpawnEmitterOnEnd : 1;                                   // 0x054C(0x0004) (Edit)
	unsigned long                                      bUseOffHandForEmitter : 1;                                // 0x054C(0x0004) (Edit)
	unsigned long                                      bConsumeManaOnSpecial : 1;                                // 0x054C(0x0004) (Edit)
	unsigned long                                      bStopAttackOnComplete : 1;                                // 0x054C(0x0004) (Edit)
	unsigned long                                      bDoingAttack : 1;                                         // 0x054C(0x0004)
	unsigned long                                      bLockedStance : 1;                                        // 0x054C(0x0004) (Net)
	unsigned long                                      bSpecialStarted : 1;                                      // 0x054C(0x0004) (Net)
	unsigned long                                      bDoingMainHandDmg : 1;                                    // 0x054C(0x0004)
	unsigned long                                      bDoingOffHandDmg : 1;                                     // 0x054C(0x0004)
	class ADunDefEmitterDamage*                        EndDamageEmitter;                                         // 0x0550(0x0004) (Edit)
	class UParticleSystemComponent*                    StunEffectComponent;                                      // 0x0554(0x0004) (Edit, ExportObject, Component, EditInline)
	int                                                ManaCostForSpecial;                                       // 0x0558(0x0004) (Edit)
...
// 0x02D0 (0x0700 - 0x0430)
class ADunDefPlayerAbility_WheeloFortuna : public ADunDefPlayerAbility
{
public:
	class UMaterialInterface*                          SlotMachineMat;                                           // 0x0430(0x0004) (Edit)
	TArray<struct FGlyphPattern>                       myPatterns;                                               // 0x0434(0x000C) (Edit, NeedCtorLink)
	struct FGlyphIcon                                  wheelSlots[0x3];                                          // 0x0440(0x0020) (Edit)
	float                                              GlobalSpinSpeedMult;                                      // 0x04A0(0x0004) (Edit)
	float                                              WheelIconSizeX;                                           // 0x04A4(0x0004) (Edit)
	float                                              WheelIconSizeY;                                           // 0x04A8(0x0004) (Edit)
	float                                              WheelStepValue;                                           // 0x04AC(0x0004) (Edit)
	unsigned long                                      bForceTestPattern : 1;                                    // 0x04B0(0x0004) (Edit)
	unsigned long                                      bDoingTimeDilation : 1;                                   // 0x04B0(0x0004) (Transient)
	unsigned long                                      bForceSelections : 1;                                     // 0x04B0(0x0004) (Transient)
	unsigned long                                      bDoFadeOut : 1;                                           // 0x04B0(0x0004) (Transient)
	unsigned long                                      bFinished : 1;                                            // 0x04B0(0x0004) (Transient)
	struct FGlyphPattern                               testPattern;                                              // 0x04B4(0x0084) (Edit, NeedCtorLink)
	class UMaterialInstanceConstant*                   GoldMaterialTemplate;                                     // 0x0538(0x0004) (Edit)
	int                                                defaultManaAmount;                                        // 0x053C(0x0004) (Edit)
	float                                              defaultManaExp;                                           // 0x0540(0x0004) (Edit)
	class ADunDefManaToken*                            SmallManaTokenTemplate;                                   // 0x0544(0x0004) (Edit)
	class ADunDefManaToken*                            MinorManaTokenTemplate;                                   // 0x0548(0x0004) (Edit)
	class ADunDefManaToken*                            LargeManaTokenTemplate;                                   // 0x054C(0x0004) (Edit)
	float                                              ManaTokenImpulseMagnitude;                                // 0x0550(0x0004) (Edit)
	float                                              ManaTokenTorqueMagnitude;                                 // 0x0554(0x0004) (Edit)
	struct FVector                                     ManaTokenImpulseUpOffset;                                 // 0x0558(0x000C) (Edit)
	struct FString                                     defaultNoMatchMessage;                                    // 0x0564(0x000C) (Edit, Localized, NeedCtorLink)
	float                                              EndLingerTime;                                            // 0x0570(0x0004) (Edit)
	struct FName                                       DanceStartAnimName;                                       // 0x0574(0x0008) (Edit)
	struct FName                                       DanceLoopAnimName;                                        // 0x057C(0x0008) (Edit)
	struct FName                                       DanceEndAnimName;                                         // 0x0584(0x0008) (Edit)
	struct FLinearColor                                DefaultSelection;                                         // 0x058C(0x0010) (Edit)
	struct FLinearColor                                goodSelection;                                            // 0x059C(0x0010) (Edit)
	struct FName                                       selectionBarParamName;                                    // 0x05AC(0x0008) (Edit)
	struct FName                                       selectionFlashParamName;                                  // 0x05B4(0x0008) (Edit)
	float                                              ManaCostToActivate;                                       // 0x05BC(0x0004) (Edit)
	float                                              WheelFadeInTime;                                          // 0x05C0(0x0004) (Edit)
	float                                              WheelFadeOutTime;                                         // 0x05C4(0x0004) (Edit)
	class USoundCue*                                   StopWheelSound;                                           // 0x05C8(0x0004) (Edit)
	class USoundCue*                                   DefaultSound;                                             // 0x05CC(0x0004) (Edit)
	class UAudioComponent*                             LoopingWheelSound;                                        // 0x05D0(0x0004) (Edit, ExportObject, Component, EditInline)
	struct FName                                       WheelOpacityName;                                         // 0x05D4(0x0008) (Edit)
	float                                              fadeOutDelay;                                             // 0x05DC(0x0004) (Edit)
	TArray<class UClass*>                              GRInotallowedon;                                          // 0x05E0(0x000C) (Edit, NeedCtorLink)
	struct FString                                     DummyPercentDamageString;                                 // 0x05EC(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     DummyPercentHealingString;                                // 0x05F8(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     DummyDamageTakenByPlayerString;                           // 0x0604(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     DummyDamageDoneByPlayerString;                            // 0x0610(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     DummyDamageTakenByEnemyString;                            // 0x061C(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     DummyDamageDoneByEnemyString;                             // 0x0628(0x000C) (Edit, Localized, NeedCtorLink)
	struct FString                                     DummyPercentGoldedString;                                 // 0x0634(0x000C) (Edit, Localized, NeedCtorLink)
	int                                                currentStopIndex;                                         // 0x0640(0x0004) (Transient)
	int                                                currentPatternIdx;                                        // 0x0644(0x0004) (Transient)
	struct FGlyphPattern                               selectedPattern;                                          // 0x0648(0x0084) (Transient, NeedCtorLink)
	TArray<class ADunDefPawn*>                         boostingPawns;                                            // 0x06CC(0x000C) (Transient, NeedCtorLink)
	TArray<class ADunDefPracticeDummy*>                boostingDummies;                                          // 0x06D8(0x000C) (Transient, NeedCtorLink)
	TArray<class ADunDefEnemy*>                        goldedEnemies;                                            // 0x06E4(0x000C) (Transient, NeedCtorLink)
	TArray<class ADunDefEnemy*>                        stunnedPawns;                                             // 0x06F0(0x000C) (Transient, NeedCtorLink)
	class UMaterialInstanceConstant*                   mySlotMIC;                                                // 0x06FC(0x0004)
...
// 0x008D (0x0569 - 0x04DC)
class ADunDefPlayerAbility_WhirlWind : public ADunDefPlayerAbility_AreaOfEffect
{
public:
	float                                              WhirlWindDamage;                                          // 0x04DC(0x0004) (Edit)
	float                                              WhirlWindElementalDamage;                                 // 0x04E0(0x0004) (Edit)
	float                                              WhirlWindDamageMomentum;                                  // 0x04E4(0x0004) (Edit)
	float                                              WhirlWindDamageMultiplier;                                // 0x04E8(0x0004) (Edit)
	float                                              WhirlWindDamageExponent;                                  // 0x04EC(0x0004) (Edit)
	class UClass*                                      WhirlWindDamageType;                                      // 0x04F0(0x0004) (Edit)
	class UClass*                                      WhirlWindElementalDamageType;                             // 0x04F4(0x0004) (Edit)
	float                                              WhirlWindDuration;                                        // 0x04F8(0x0004) (Edit, Net)
	unsigned long                                      bCancelAbilityAfterDuration : 1;                          // 0x04FC(0x0004) (Edit)
	unsigned long                                      bUseElementalVFX : 1;                                     // 0x04FC(0x0004) (Edit)
	unsigned long                                      bUseWeaponDamage : 1;                                     // 0x04FC(0x0004) (Edit)
	struct FName                                       IdleAnimationName;                                        // 0x0500(0x0008) (Edit)
	class UParticleSystem*                             ElementalVFXEntries[0xB];                                 // 0x0508(0x0004) (Edit)
	class UParticleSystem*                             ElementalDamageVFXEntries[0xB];                           // 0x0534(0x0004) (Edit)
	class UParticleSystem*                             CachedAbilityEffect;                                      // 0x0560(0x0004) (Transient)
	class UParticleSystem*                             CachedAbilityActorEffect;                                 // 0x0564(0x0004) (Transient)
	TEnumAsByte<EElementTrait>                         WeaponElementalTrait;                                     // 0x0568(0x0001) (Net, Transient)
